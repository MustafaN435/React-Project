...
export default function Info(){
    return(
        <div className = "info">   
            <img className="my-image" src="../images/My-cv-image.jpeg"/>   
            <h1>Mustafa Noor</h1>
            <p className = "my-field">Frontend Developer</p>
            <p className = "my-website">mustafanoor.website</p>  
            <button className = "email-button"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
